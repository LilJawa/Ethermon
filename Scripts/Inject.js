...
function DestroyObjects(Element){
  ...
  function LoadFont(){
	new FontFace('EthermonSolid', 'url(https://raw.githubusercontent.com/LilJawa/Ethermon/blob/main/Fonts/Pokemon_Solid.ttf)').load().then(function(font){ document.fonts.add(font); });
	new FontFace('EthermonHollow', 'url(https://raw.githubusercontent.com/LilJawa/Ethermon/blob/main/Fonts/Pokemon_Hollow.ttf)').load().then(function(font){ document.fonts.add(font); });      
}    
