...
function DestroyObjects(Element){
  ...
  function LoadFont(){
	new FontFace('EthermonSolid', 'url(https://github.com/LilJawa/Ethermon/blob/main/Fonts/Pokemon_Solid.ttf)').load().then(function(font){ document.fonts.add(font); });
	new FontFace('EthermonHollow', 'url(https://github.com/LilJawa/Ethermon/blob/main/Fonts/Pokemon_Hollow.ttf)').load().then(function(font){ document.fonts.add(font); });      
}    
